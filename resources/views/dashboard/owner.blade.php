...
<head>
    ...
    <title>Dashboard Pemilik - TriniStay</title>
...
<body class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center gap-4">
                    <span class="text-white text-sm">{{ Auth::user()->name }} (Pemilik Kos)</span>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-8">
            <h1 class="text-2xl font-bold text-navy mb-4">Dashboard Pemilik Kos</h1>
            <p class="text-gray-600">Selamat datang, {{ Auth::user()->name }}!</p>
            <p class="text-gray-500 mt-2">Anda login sebagai <span class="font-semibold text-navy">Pemilik Kos</span>.</p>
            ...
            <div class="mt-6 p-6 bg-yellow-50 rounded-lg border border-yellow-200">
                ...
                <p class="text-yellow-700 text-sm">Halaman kelola properti dan fitur lainnya sedang dalam pengembangan.</p>
            </div>
        </div>
    </main>
</body>
