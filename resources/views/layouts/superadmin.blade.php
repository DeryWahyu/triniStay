            ...
            <nav class="mt-6 px-4">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('superadmin.reviews.index') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('superadmin.reviews.*') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-navy-light hover:text-white' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
