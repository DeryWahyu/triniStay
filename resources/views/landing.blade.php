            ...
            <div class="nav-container">
                ...
                @auth
                    <div class="nav-auth">
                        ...
                        <a href="{{ match(Auth::user()->role) { 'superadmin' => route('superadmin.dashboard'), 'owner' => route('owner.dashboard'), 'renter' => route('renter.dashboard') } }}" class="btn-masuk">Dashboard</a>
                    </div>
                @else
