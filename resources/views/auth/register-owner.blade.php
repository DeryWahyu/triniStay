...
<head>
    ...
    <title>Daftar Pemilik Kos - TriniStay</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center p-8 md:p-12">
            <div class="w-full max-w-md">
                ...
                <!-- Title -->
                <h1 class="text-3xl font-bold text-navy mb-2">Daftar sebagai Pemilik Kos</h1>
                <p class="text-gray-500 mb-8">Buat akun untuk mulai mengelola properti kos Anda.</p>
                ...
                <!-- Registration Form -->
                <form action="{{ route('register.owner') }}" method="POST" class="space-y-5">
                    @csrf
