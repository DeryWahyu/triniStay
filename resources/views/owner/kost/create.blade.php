...
<div class="max-w-4xl mx-auto" x-data="{ roomMatch: false }">
    <form id="create-kost-form" action="{{ route('owner.kost.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="flex items-center justify-end space-x-4">
            ...
            <button type="button" onclick="confirmCreate()" class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium flex items-center">
...
// SweetAlert confirmation for Create
function confirmCreate() {
    const form = document.getElementById('create-kost-form');
    const kostName = document.getElementById('name').value || 'Kos Baru';

    Swal.fire({
        title: 'Simpan Data Kos?',
        html: `Apakah Anda yakin ingin menyimpan data kos <strong>"${kostName}"</strong>?`,
        icon: 'question',
